...
enum { ID1 = 0x201, ID2, ID3, ID4, ID5, ID6, ID7, ID8 }; // DJI电机反馈ID：0x201~0x208，ID1对应反馈0x201
enum { pre = 0, now };
...
public:
	...
	int32_t current{}, curspeed{}, setcurrent{},setspeed{}, current_feedforward{}, torque_current, motor_status, motor_angle_status, sum_angle{};//这个current用于输出电流或者电压
	int16_t adjspeed{};
	...
	PID pid[3]; // [后续修改] speed/position/speed2三组PID，支持6020位置环+速度环
